...
export const messages = {
  en: {
    ...
    catCreatorsDesc: "Salad, Stalad, artists 邮箱 / WATER_ / 花生酱 / 云陌商 / 言 / 凉菜 / 小E, mascot 不改, modeler 男玩, and animator Flow.",
  ...
  zh: {
    ...
    catCreatorsDesc: "Salad、Stalad、画师 邮箱 / WATER_ / 花生酱 / 云陌商 / 言 / 凉菜 / 小E、吉祥物 不改、建模师 男玩，以及动画师 Flow。",
    catPersonalitiesDesc:
